...
def source_contract(main_text: str, toc_text: str) -> dict[str, Any]:
    checks = {
        ...
        "registersStartupRefresh": "Event.Addon.Startup.End" in main_text and ("refreshAll()" in main_text or "refreshLiveApiCoord(true)" in main_text),
        "registersUpdateRefresh": "Event.System.Update.Begin" in main_text and ("refreshAll()" in main_text or "refreshLiveApiCoord(false)" in main_text),
