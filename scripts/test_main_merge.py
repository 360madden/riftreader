# Version: riftreader-main-merge-tests-v0.1.2
# Total-Character-Count: 5596
...
class MainMergeTests(unittest.TestCase):
    ...
    def test_policy_lint_paths_are_allowed(self) -> None:
        self.assertIn("tools/riftreader_workflow/policy_lint.py", main_merge.ALLOWED_PATHS)
        self.assertIn("scripts/riftreader-policy-lint.cmd", main_merge.ALLOWED_PATHS)
        self.assertIn("scripts/test_policy_lint.py", main_merge.ALLOWED_PATHS)
        self.assertIn("docs/workflow/policy-lint.md", main_merge.ALLOWED_PATHS)
        self.assertIn(".github/workflows/riftreader-policy.yml", main_merge.ALLOWED_PATHS)
        self.assertIn("handoffs/current/RIFTREADER_POLICY_LINT_SUMMARY.json", main_merge.ALLOWED_PATHS)
        self.assertIn("handoffs/current/RIFTREADER_POLICY_LINT_SUMMARY.md", main_merge.ALLOWED_PATHS)
