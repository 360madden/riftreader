# Version: riftreader-github-review-publish-tests-v0.1.4
# Total-Character-Count: 6774
...
class GitHubReviewPublishTests(unittest.TestCase):
    ...
    def test_policy_lint_paths_are_allowlisted(self) -> None:
        self.assertIn("tools/riftreader_workflow/policy_lint.py", grp.ALLOWED_STAGE_PATHS)
        self.assertIn("scripts/riftreader-policy-lint.cmd", grp.ALLOWED_STAGE_PATHS)
        self.assertIn("scripts/test_policy_lint.py", grp.ALLOWED_STAGE_PATHS)
        self.assertIn("docs/workflow/policy-lint.md", grp.ALLOWED_STAGE_PATHS)
        self.assertIn(".github/workflows/riftreader-policy.yml", grp.ALLOWED_STAGE_PATHS)
        self.assertIn("handoffs/current/RIFTREADER_POLICY_LINT_SUMMARY.json", grp.ALLOWED_STAGE_PATHS)
        self.assertIn("handoffs/current/RIFTREADER_POLICY_LINT_SUMMARY.md", grp.ALLOWED_STAGE_PATHS)
