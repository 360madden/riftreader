...
if ($RequireLiveChain -and $null -eq $behaviorBackedLead) {
...
$notes.Add('Add -RequireLiveChain when you need owner/source artifact refresh to fail closed instead of silently reusing cached fallback artifacts.')
