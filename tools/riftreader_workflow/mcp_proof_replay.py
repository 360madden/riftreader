    ...
    *,
    ...
    return {
        ...
        "proofSummary": {
            ...
            "clientTransportStatus": proof.get("clientTransportStatus") if isinstance(proof, dict) else None,
            "healthCallSucceeded": proof.get("healthCallSucceeded") if isinstance(proof, dict) else None,
