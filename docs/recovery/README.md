...
5. `C:\RIFT MODDING\RiftReader\docs\recovery\actor-yaw-recovery-prompt.json`
...
- `actor-yaw-recovery-prompt.json` = machine-readable downstream execution packet for fastest post-update actor-yaw recovery
