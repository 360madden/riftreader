...
and `x64dbg-coordinate-chain-compact-handoff.json` with the readiness verdict,
blockers, artifact paths, safety state, and a ready-to-paste resume prompt.
Summary and handoff markdown include readiness evidence inline for quick review
without opening the JSON packet.
