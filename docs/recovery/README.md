...
- `C:\RIFT MODDING\RiftReader_facing\docs\analysis\2026-04-14-post-update-anchor-drift-report.md`
...
1. `C:\RIFT MODDING\RiftReader_facing\docs\recovery\current-truth.md`
2. `C:\RIFT MODDING\RiftReader_facing\docs\recovery\rebuild-runbook.md`
3. `C:\RIFT MODDING\RiftReader_facing\docs\recovery\artifact-tiers.md`
...
- `C:\RIFT MODDING\RiftReader_facing\docs\analysis\README.md` = how to record dated
