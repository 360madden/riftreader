...
- One over-broad depth-2 pointer scan was intentionally stopped after it began expanding too many ref-storage targets; the bounded depth-0 scan above is the current documented pointer-scan evidence. Next pointer work should stay bounded or use a tighter owner/ranking strategy.
