...
| x64dbg static-chain plan packet | No x64dbg was launched, but a no-attach plan packet was generated for the focused lead: `scripts/captures/x64dbg-coord-chain-plan-20260513-185452-310224/coord-chain-plan-summary.json`; manual access-event template: `scripts/captures/x64dbg-access-event-template-20260513-185456-929323/x64dbg-manual-access-events-template.json`. Watch window should be the 12-byte triplet at `0x268DF21ED30`; evidence remains candidate-only until access events are ingested and a module/static-owner chain is proven. |
