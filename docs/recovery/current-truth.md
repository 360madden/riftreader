...
- Latest post-AddonSettings milestone review `scripts/captures/riftscan-milestone-review-20260514-014113.json` is unchanged: it routes the selected family candidate to read-only proof only and keeps `movementAllowedByReview=false`. This does not override the fresh-reference blocker.
