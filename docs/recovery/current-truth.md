...
| Exact-target preflight | Passed with `responding=true`, `windowVisible=true`, and debugger process count `0`: initial exact check `scripts/captures/x64dbg-target-preflight-20260513-165343-990550/summary.json`; post-scan check `scripts/captures/x64dbg-target-preflight-20260513-170413-554633/summary.json`. |
| API/runtime coordinate | Fresh ChromaLink world-state reference passed: `scripts/captures/chromalink-world-state-reference-20260513-170034-699164/summary.json`; coordinate `X=7397.52`, `Y=871.78`, `Z=3027.98`, observed `2026-05-13T17:00:34.6914755+00:00`, age `0.01ms`. |
...
| Adjusted grouped scan | Read-only stride-4 scan `scripts/captures/family-scan-currentpid-2928-20260513-170101-859202/family-scan-summary.json` blocked with `no_xyz_triplets_near_reference_found` after the 90-second scan budget; tolerance `2.0`, `hitCount=0`, `bytesScanned=390070272`. |
| Bounded stride-1 scan | Read-only stride-1 scan `scripts/captures/family-scan-currentpid-2928-20260513-170252-761030/family-scan-summary.json` blocked with `no_xyz_triplets_near_reference_found` after the 60-second scan budget; tolerance `2.0`, `hitCount=0`, `bytesScanned=67108864`. |
...
| Latest handoff | `docs/handoffs/2026-05-13-1304-currentpid-2928-no-candidate-scan-blocker.md`; supporting compact resume `docs/handoffs/2026-05-13-1231-compact-static-pointer-chain-resume.md` and detailed PID `60628` blocker handoff `docs/handoffs/2026-05-13-0729-currentpid-60628-threepose-candidate-blocker.md`. |
