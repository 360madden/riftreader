...
| Contract index | Shared helper/envelope/freshness/classification contract map. | docs-only | `docs\workflow\riftreader-chatgpt-mcp-contracts.md` | Link-first; does not replace the final-readiness tool-surface contract. |
