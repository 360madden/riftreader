...
- inspects all seven projection `.cmd` wrappers for the repo-standard `_run-pwsh.cmd` launcher and expected `.ps1` target
...
| CMD wrapper inspection | Passed for 7 wrappers, including launcher and target-script checks. |
