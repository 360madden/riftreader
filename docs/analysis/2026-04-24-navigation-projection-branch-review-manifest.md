...
| `C:\RIFT MODDING\RiftReader\scripts\test-projection-screenshot-gate-workflow.ps1` | Offline validation for parser checks, capture helper build, wrapper plan shape, and optional analyzer visual-gate smoke. |
...
PowerShell wrapper plan, CMD wrapper plan, and analyzer visual-gate smoke all
passed.
