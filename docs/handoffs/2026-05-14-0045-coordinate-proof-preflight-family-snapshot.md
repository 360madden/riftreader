...
_Last updated: 2026-05-14 01:40 UTC._
...
| `scripts/captures/riftscan-milestone-review-20260514-014113.json` | Post-AddonSettings strategy gate unchanged: selected family candidate remains read-only proof candidate; `movementAllowedByReview=false`; fresh-reference/preflight blocker still controls. |
