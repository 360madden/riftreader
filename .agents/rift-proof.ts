 ...
 *   - Three-pose displacement validation (baseline to pose-A to pose-B)
...
2. NEVER send movement/stimulus without params.movementApproved == true.
...
7. Fail closed on any ambiguity — it is safer to block than to approve incorrectly.`,
